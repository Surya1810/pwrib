...
@section('content')
    <div class="container mt-3">
        <h1 class="fs-3 fw-600 mb-3 text-center">Pendaftaran DPD/DPC</h1>
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <h1 class="fs-3 fw-600 my-3 text-center">Formulir Pendaftaran DPD</h1>
                <div class="row">
                    <div class="col-12">
                        <a href="{{ route('download.dpd') }}">
            ...
            <div class="col-12 col-md-6">
                <h1 class="fs-3 fw-600 my-3 text-center">Formulir Pendaftaran DPC</h1>
                <div class="row">
                    <div class="col-12">
                        <a href="{{ route('download.dpc') }}">
                            <div class="card bg-primary rounded-5 text-white">
                                <div class="card-body text-center">
                                    <i class="fa-solid fa-file-word"></i> Unduh
                                </div>
                    ...
                    <div class="card card-outline rounded-web card-secondary">
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12">
                                        <label for="jenis" class="mb-0 form-label col-form-label-sm">Jenis
                                            Kepengurusan</label>
                                        <select name="jenis" id="jenis"
                                            class="form-select @error('jenis') is-invalid @enderror" required>
                                            <option value="" disabled {{ old('jenis') ? '' : 'selected' }}>Pilih Jenis
                                            </option>
                                            <option value="dpd" {{ old('jenis') == 'dpd' ? 'selected' : '' }}>DPD
                                            </option>
                                            <option value="dpc" {{ old('jenis') == 'dpc' ? 'selected' : '' }}>DPC
                                            </option>
                                        </select>
                                        @error('jenis')
